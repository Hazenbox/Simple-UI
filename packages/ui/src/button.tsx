...
// Wrap the component to handle refs and motion
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    const Comp = asChild ? Slot : "button"

    // If it's a Slot, we can't easily wrap it in motion without breaking composition
    // So we apply motion only to the non-Slot version for now, or use a motion.button
